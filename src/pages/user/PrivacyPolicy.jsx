  ...
  return (
    <div>
      <div className="w-full">
        ...
        <p className="text-center font-medium text-[22px] poppins-medium text-[#666666]">Last updated on 1-12-2021</p>
        <section className="max-w-[1300px] w-full m-auto">
          <div className="mx-5 flex flex-col justify-start my-4 lg:my-14 items-start md:mx-20 lg:mx-28 ">
            <section className="grid  grid-cols-1 ">
              <div className="">
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">1. INTRODUCTION</h1>
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">2. YOUR INFORMATION</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                    ...
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                    (c) such information is not shared with the website , ‘The Property Seller’, its branches, partners and any other third parties or users of the Website and Services.
                    </p>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">3. COLLECTING AND USING INFORMATION:</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
...
f)To give you information about goods and services that might be of interest to you or let you select third parties to do the same.
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">4. DISCLOSURE OF PERSONAL INFORMATION</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">5. SECURITY</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">6. STORAGE OF YOUR PERSONAL INFORMATION</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">7. YOUR RIGHT TO ACCESS AND CORRECT YOUR PERSONAL INFORMATION</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">8. USE OF COOKIES</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">9. USE OF THIRD PARTY ANALYTICS AND TRACKING PIXELS</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">13. LINKS AND CONNECTIONS TO AND USE OF OTHER THIRD-PARTY SERVICES</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                    13.1 Our site may contain links that are connected to third party apps, which you may come across while using the website, that are not directly linked to us. These links may lead you to social media or other related sites that are not controlled by us. The Privacy policies of these third party sites are governed by their own policy statements over which we have no control. You are requested to review the Terms of Use and Privacy Policy of these third party links. Information that is provided to third-party companies or sites does not come under this Policy.
                    </p>
                 </div>

                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">14. PRIVACY OF MINORS</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                        14.1 Minors are not allowed to use the website or its services.Our users should be of the age of 18 or more. Any information collected about minors with the use of the site will comply with applicable laws.
                    </p>
                 </div>


                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">15. BUSINESS TRANSFER</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                        15.1 As part of business transfer or acquisitions or in the unlikely event of insolvency the information gathered from the site will have to be transferred to the company or organization taking over, pursuant to this Policy that will form part of the transferred assets. As a user you acknowledge the transfer of the information to the acquirer or successor to ‘The Property Seller’, who may continue to use the data pursuant to this Privacy Policy, in the way detailed in this document.
                    </p>
                 </div>
