        ...
        <section className="max-w-[1300px] w-full m-auto">
          <div className="mx-5 flex flex-col justify-start my-4 lg:my-14 items-start md:mx-20 lg:mx-28 ">
            <section className="grid  grid-cols-1 ">
              <div className="">
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">1. TERMS</h1>
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">2. USE LICENSE & RESTRICTIONS:</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">3. YOUR RESPONSIBILITIES</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">5. REVISIONS AND ERRATA</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">6. AVAILABILITY OF WEBSITE</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">7. THIRD PARTY ADVERTISEMENTS</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">8. SITE TERMS OF USE MODIFICATIONS</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">9. CONTRIBUTIONS</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">10. INTELLECTUAL PROPERTY</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">11. ELECTRONIC COMMUNICATIONS</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">12. INDEMNITY</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">13. DISCLAIMER</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">14. MONITORING AND RECORDING TELEPHONE CALLS</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                 ...
                 <div className="pb-4">
                    <h1 className="pb-2 text-[35px] font-bold sf-bold">15. GOVERNING LAW</h1>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
