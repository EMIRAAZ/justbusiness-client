  ...
  return (
    ...
    <div className=" flex justify-between mb-8 flex-col sm:flex-row overflow-hidden">
      <div className="pb-6 sm:pb-0 flex justify-center items-center">
        ...
        <Lazyloading alt={'loading'} src={FooterLogoTransparentWhiteLogo} className={' object-contain sm:min-w-[300px] ml-0 md:-ml-14'}  />
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-4 items-center sm:hidden me-5">
          ...
          <span className="text-white text-[10px] sm:text-[14px] ">Follow Us</span>
        </div>
      </div>
    </div>
    <div className="">
