  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex gap-2 sf-medium text-2xl">
        ...
        <div onClick={()=>navigate('/admin/edit-blogs')} className="flex h-20 lg:h-16   items-center  flex-1 justify-between px-6 rounded-[10px] bg-[#000000] text-[#FFFFFF]">
      ...
      <div className="flex gap-2 sf-medium text-2xl">
        ...
        <div onClick={()=>navigate('/admin/developers')} className="flex h-20 lg:h-16   items-center  flex-1 justify-between px-6 rounded-[10px] bg-[#000000] text-[#FFFFFF]">
