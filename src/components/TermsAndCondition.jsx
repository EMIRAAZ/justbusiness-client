...
function TermsAndCondition() {
  return (
    <div>
       <h1 className="text-center text-[#016EFF] mt-4 sf-medium-600 text-[30px] sm:text-[70px]">
              ...
              <div className="text-[#016EFF]">
                 <div className="pb-4 " >
                    ...
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                        1.1 The term mentioned here as ‘we’,’our’ and ‘us’ would mean ‘JustBusiness, its representatives, subsidiaries, agents, affiliates or its assigned parties.
                    </p>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
                        1.2 The website and its contents is herein referred to as ‘www.justbusiness.com.
                    </p>
                    <p className="pb-2 font-medium text-[15px] poppins text-[#666666]">
