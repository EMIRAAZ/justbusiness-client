    ...
    <form onSubmit={handleSubmit} className='flex flex-wrap'>
        <div className='flex-1'>
            ...
            <div className="flex flex-col gap-2 mx-3 mt-3">
                ...
                <textarea  disabled={isLoading} name="blogBody"  onChange={handleChange} value={formData.blogBody} id="blogBody" cols="30" rows="20" className="border border-[#E4E4E4] py-4 px-5 rounded-[10px] sf-normal text-sm text-[#666666]  outline-none"
