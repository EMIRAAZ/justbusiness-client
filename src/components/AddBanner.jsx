    ...
    <form onSubmit={handleSubmit} className='flex flex-wrap'>
        <div className='flex-1'>
            ...
            <div className="flex flex-col gap-2 mx-3">
                ...
                <input disabled={isLoading} autoComplete="" value={formData.bannerHeadline} name="bannerHeadline" onChange={handleChange} type="text" id="bannerHeadline" placeholder="Find Your Dream Home Today" className="border border-[#E4E4E4] py-4 px-5 rounded-[10px] sf-normal font-extralight text-sm text-[#666666]  outline-none" />
            </div>
